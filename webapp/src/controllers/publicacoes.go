...
//CriarPublicacao chama a API e  cria uma nova publicacao
func CriarPublicacao(w http.ResponseWriter, r *http.Request) {
	r.ParseForm()

	publicacao, erro := json.Marshal(map[string]string{ //publicacao no formato JSON
...
//CurtirPublicacao cyrte uma publicacao
...
//DescurtirPublicacao descurte uma publicacao
...
//AtualizarPublicacao chama a API apara atualizar
...
//DeletarPublicacao chama a AP para deletar uma publicacao
