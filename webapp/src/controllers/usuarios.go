...
//CriarUsuario chama na api e cria um usuario novo no banco de dados
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	r.ParseForm()

	usuario, erro := json.Marshal(map[string]string{ //usuario no formato JSON
...
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	url := fmt.Sprintf("%s/usuarios/%d/not-follow", config.APIURL, usuarioID)
...
//SeguirUsuario chma a API para seguir um usuario
...
func EditarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	cookie, _ := cookies.Ler(r) //pegando o usuario que ta no token
...
//AtualizarSenha chama a API para atualizar a senha
...
//DeletarUsuario chama a API para deletar o usuario
